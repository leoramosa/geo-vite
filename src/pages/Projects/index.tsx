    ...
    <>
      <div className="content_projects">
        ...
        {projects.map((project, i) => (
          <div key={i} className={`row_projects`}>
                ...
                <div className="wrapper_all-projects">
                  ...
                  <div className="content-button-projects">
                    <div className="content-bo-projects">
                      <a
                        className="btn-whatsapp-projects"
                        href={`https://api.whatsapp.com/send?phone=51995508944&text=${project.mensaje}${project.name}`}
                        rel="noopener noreferrer"
                        target="_blank"
                      >
                        <button
                          className="button-whatsapp-projects"
                          type="button"
                        >
                          <i className="fab fa-whatsapp-projects"></i>{" "}
                          {project.buttonstyle}
                        </button>
                      </a>
                    </div>
